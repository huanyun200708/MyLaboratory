...
public class MessageReceiverWithoutJNDI117 implements ExceptionListener,
	...
	private void init() throws JMSException, NamingException,
        ...
        connectionParams.put(TransportConstants.HOST_PROP_NAME, "10.110.2.126");
        ...
        connectionParams.put(TransportConstants.TRUSTSTORE_PASSWORD_PROP_NAME,"ACROSS_dpl_2013");
        ...
        Destination queue = null;
		 try {
	        	queue = HornetQJMSClient.createTopic("monitor_topic");
	        	messageConsumer = session.createConsumer(queue); 
			} catch (Exception e) {
				queue = HornetQJMSClient.createQueue("monitor_topic");
				messageConsumer = session.createConsumer(queue); 
			}
		messageConsumer = session.createConsumer(queue, "");
