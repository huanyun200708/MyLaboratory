...
public class HandleJavaFormateFileAndFindAllOpreLogCodeImp implements HandleJavaFormateFile {
	...
	public boolean isNeededLine(String line) {
		if(line.matches(".*\\.addOperationLog\\(.*")){
			String [] ss = line.split(",");
			if(!ss[2].contains("ObjectLogEnum") || !ss[4].contains("ActionLogEnum")){
				return true;
			}
		}
		return false;
